...
# Load environment preps in script 4.1_data_prep.R 
...
text.pos = 0.38
p.NR<- p.NR.boxes +
  annotate("rect", xmin = 17.5, xmax = 19.5, ymin = ymin.rect.NR, ymax = ymax.rect.NR, alpha = .3,fill = pal[1])+
  annotate("rect", xmin = 16.5, xmax = 17.5, ymin = ymin.rect.NR, ymax = ymax.rect.NR, alpha = .3,fill = pal[2])+
  annotate("rect", xmin = 14.5, xmax = 16.5, ymin = ymin.rect.NR, ymax = ymax.rect.NR, alpha = .3,fill = pal[3])+
  annotate("rect", xmin = 13.5, xmax = 14.5, ymin = ymin.rect.NR, ymax = ymax.rect.NR, alpha = .3,fill = pal[3])+
  annotate("rect", xmin = 8.5, xmax = 13.5, ymin = ymin.rect.NR, ymax = ymax.rect.NR, alpha = .3,fill = pal[5])+
  annotate("rect", xmin = 7.5, xmax = 8.5, ymin = ymin.rect.NR, ymax = ymax.rect.NR, alpha = .3,fill = pal[11])+
  annotate("rect", xmin = 6.5, xmax = 7.5, ymin = ymin.rect.NR, ymax = ymax.rect.NR, alpha = .3,fill = pal[11])+
  annotate("rect", xmin = 5.5, xmax = 6.5, ymin = ymin.rect.NR, ymax = ymax.rect.NR, alpha = .3,fill = pal[8])+
  annotate("rect", xmin = 3.5, xmax = 5.5, ymin = ymin.rect.NR, ymax = ymax.rect.NR, alpha = .3,fill = pal[9])+
  annotate("rect", xmin = 2.5, xmax = 3.5, ymin = ymin.rect.NR, ymax = ymax.rect.NR, alpha = .3,fill = pal[10])+
  annotate("rect", xmin = 1.5, xmax = 2.5, ymin = ymin.rect.NR, ymax = ymax.rect.NR, alpha = .3,fill = pal[7])+
  annotate("rect", xmin = 0.5, xmax = 1.5, ymin = ymin.rect.NR, ymax = ymax.rect.NR, alpha = .3,fill = pal[12])+
  geom_boxplot(width = 0.5, outlier.size = 0.05, lwd = 0.2)+
...
p.NRSPO<- p.NRSPO.boxes +
  annotate("rect", xmin = 17.5, xmax = 19.5, ymin = ymin.rect.NRSPO, ymax = ymax.rect.NRSPO, alpha = .3,fill = pal[1])+
  annotate("rect", xmin = 16.5, xmax = 17.5, ymin = ymin.rect.NRSPO, ymax = ymax.rect.NRSPO, alpha = .3,fill = pal[2])+
  annotate("rect", xmin = 14.5, xmax = 16.5, ymin = ymin.rect.NRSPO, ymax = ymax.rect.NRSPO, alpha = .3,fill = pal[3])+
  annotate("rect", xmin = 13.5, xmax = 14.5, ymin = ymin.rect.NRSPO, ymax = ymax.rect.NRSPO, alpha = .3,fill = pal[3])+
  annotate("rect", xmin = 8.5, xmax = 13.5, ymin = ymin.rect.NRSPO, ymax = ymax.rect.NRSPO, alpha = .3,fill = pal[5])+
  annotate("rect", xmin = 7.5, xmax = 8.5, ymin = ymin.rect.NRSPO, ymax = ymax.rect.NRSPO, alpha = .3,fill = pal[11])+
  annotate("rect", xmin = 6.5, xmax = 7.5, ymin = ymin.rect.NRSPO, ymax = ymax.rect.NRSPO, alpha = .3,fill = pal[11])+
  annotate("rect", xmin = 5.5, xmax = 6.5, ymin = ymin.rect.NRSPO, ymax = ymax.rect.NRSPO, alpha = .3,fill = pal[8])+
  annotate("rect", xmin = 3.5, xmax = 5.5, ymin = ymin.rect.NRSPO, ymax = ymax.rect.NRSPO, alpha = .3,fill = pal[9])+
  annotate("rect", xmin = 2.5, xmax = 3.5, ymin = ymin.rect.NRSPO, ymax = ymax.rect.NRSPO, alpha = .3,fill = pal[10])+
  annotate("rect", xmin = 1.5, xmax = 2.5, ymin = ymin.rect.NRSPO, ymax = ymax.rect.NRSPO, alpha = .3,fill = pal[7])+
  annotate("rect", xmin = 0.5, xmax = 1.5, ymin = ymin.rect.NRSPO, ymax = ymax.rect.NRSPO, alpha = .3,fill = pal[12])+
  geom_boxplot(width = 0.5, outlier.size = 0.05, lwd = 0.2)
...
p.predict.NR<- ggplot(newdat, aes(x=NR, y=plogis(caseControl)))+
  geom_line()+
  geom_segment(data = dat.rescaled, aes(x = NR, xend = NR, y = 0, yend = 0.02), alpha = .2)+
  geom_ribbon(aes(NR, ymin = plogis(plo), ymax = plogis(phi)), alpha = .2)+
  ...
  theme(axis.title = element_text(size = 6),
        ...
        panel.border = element_blank(),
        axis.line = element_line(size = 0.3))+
  annotate('text', x = 0.4, y = 0.6, label = paste0('slope = ', b1, ', pval = ', pvalb1, '***'), size = 1.8, hjust = 0)
...
p.predict.NRSPO<- ggplot(newdat.2, aes(x=NRSPO, y=plogis(caseControl)))+
  ...
  geom_ribbon(aes(NRSPO, ymin = plogis(plo), ymax = plogis(phi)), alpha = .2)+
  ...
  theme(axis.title = element_text(size = 6),
        ...
        panel.border = element_blank(),
        axis.line = element_line(size = 0.3))+
  annotate('text', x = 0.1, y = 0.55, label = paste0('slope = ', b1, ', pval = ', pvalb1), size = 1.8, hjust = 0)
...
p.heatmap.obs.names<- ggplot(r.df, aes(x = (1-sporulation_score), y = mean_relatedness))+
  #geom_point(size = 0.1)+
  geom_text_repel(aes(label = species_id), box.padding = unit(0.1, 'line'), fontface = 'bold', segment.colour = 'black', size = 1, segment.size = 0.5)+
   #geom_tile(aes(fill = x))+
  #scale_fill_gradient2('Predicted effect\non host',low = 'firebrick', mid = 'white', high='springgreen4', midpoint = 0)+
...
pdf('./output/figures/Supp_heatmap_names.pdf', width = 17/2.55, height = 17/2.55)
p.heatmap.obs.names
dev.off()
...
save.image('~/Desktop/MMMC_HM2_run_July2021.RData')
